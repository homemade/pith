...
// error-path contracts: ReadEntry's fail-open (legacy Check) and
// CheckAndReserve's fail-closed. Configure the error you want to inject
// via the matching field; un-set fields stay benign.
